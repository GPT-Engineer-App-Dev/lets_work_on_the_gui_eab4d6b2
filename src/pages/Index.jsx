...
const Index = () => {
  ...
  return (
    <Container maxW="container.xl" p={5}>
      <VStack spacing={5}>
        <Heading as="h1" color="brand.700" mb={6}>
          ChatGPT-4 Desktop App
        </Heading>
        <Flex w="full" wrap="wrap" gap={10}>
          {/* Main Chat Interface */}
          <Box w={{ base: "full", md: "65%" }} p={5} borderWidth="2px" borderColor="brand.800" borderRadius="lg" shadow="md">
            <VStack spacing={4}>
              <Box w="full" h="500px" p={3} overflowY="auto" borderWidth="2px" borderColor="brand.800" borderRadius="lg" bg="gray.50" shadow="sm">
          ...
          <VStack w={{ base: "full", md: "35%" }} spacing={5}>
            <Box w="full" h="250px" borderWidth="1px" borderRadius="lg" overflow="hidden">
              <Image src="https://images.unsplash.com/photo-1642334640124-c80d5e7e78d3?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w1MDcxMzJ8MHwxfHNlYXJjaHwxfHxhbmltYXRlZCUyMGF2YXRhcnxlbnwwfHx8fDE3MDUzMjQ3MzJ8MA&ixlib=rb-4.0.3&q=80&w=1080" boxShadow="sm" />
            </Box>
